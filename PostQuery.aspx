<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PostQuery.aspx.cs" Inherits="_Default" EnableEventValidation="false" %>
                ...
                <div class="bhoechie-tab-content active">
                    <div class="row">
                        <div class="col-lg-8 col-md-8  col-sm-12 col-xs-12">
                            <h4 class="text-danger abc">Post Query</h4>
                ...
                <div class="bhoechie-tab-content active">
                        ...
                        <div class="pa0 col-lg-12">
                            <div class="form-group col-lg-6 col-md-3 col-sm-6 col-xs-8">
                                ...
                                <asp:TextBox ID="txtDoctorId" runat="server" placeholder="Enter Id" class="form-control"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="idCheck" runat="server" ErrorMessage="Please Enter Id" ForeColor="Red" ValidationGroup="profile" ControlToValidate="txtDoctorId" Display="Dynamic"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <br />
                        <br />
                        ...
                        <div class="pa0 col-lg-12">
                            <div class="form-group col-lg-6 col-md-3 col-sm-6 col-xs-8">
                                ...
                                <asp:Button ID="btnRegister" runat="server" Text="Post" ValidationGroup="profile" class="btn btn-success col-lg-2 pull-right" OnClick="btnRegister_Click" />
                                ...
                                <asp:Repeater ID="rptPosts" runat="server" OnItemDataBound="ItemBound">
                                    <ItemTemplate>
                                        <table>
                                            <tr>
                                                <td rowspan="3">
                                                    <asp:Image ID="imgDoctor" ImageUrl='<%#Eval("image_url") %>' runat="server" Class="avatar img-circle" Width="110px" Height="100px" /></td>
                                                <td colspan="1">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:Label class="col-sm-2" ID="lblDoctorName" Style="text-align: center; color: green" Font-Bold="true" runat="server" Text='<%#Eval("doctor_name") %>' ForeColor="Maroon"></asp:Label></td>
                                                <td>
                                                ...
                                                <asp:Repeater ID="rptChild" runat="server" OnItemDataBound="rptChild_ItemDataBound">
                                                    <ItemTemplate>
                                                        <table>
                                                            <tr>
                                                                <td rowspan="3">
                                                                    <asp:Image ID="imgDoctor" ImageUrl='<%# Eval("image_url") %>' runat="server" Width="30px" Height="30px" />
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="lblDoctorName" runat="server" Text='<%#Eval("doctor_name") %>' Font-Bold="true"></asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <asp:RadioButton ID="rbSpecialization" runat="server" Text="Specialization" GroupName="filter" class="form-control" Checked="false" onclick="__doPostBack('upFilter', '');" />
                                        <asp:RadioButton ID="rbDoctorName" runat="server" Text="DoctorName" GroupName="filter" class="form-control" Checked="false" onclick="__doPostBack('upFilter', '');" />
                                        ...
                                        <%--<div onclick="__doPostBack('upFilterButton', '');">
                                            <asp:UpdatePanel runat="server" ID="upFilterButton" OnLoad="upFilterButton_Load">
                                                <ContentTemplate>--%>
                                        <asp:Button ID="btnFetchFilterData" runat="server" Text="View" OnClick="btnFetchFilterData_Click" class="btn btn-success" />
                                        <%--  </ContentTemplate>
                                                </asp:UpdatePanel>--%>
