<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePatient.master" AutoEventWireup="true" CodeFile="PatientContactUs.aspx.cs" Inherits="_Default" %>
                ...
                <div class="col-md-8 col-sm-7 ">
                    <div class="side-content clearfix">
                        ...
                        <h4 id="reply-title" class="comment-reply-title">Leave Your Comment Here -</h4>
                            ...
                            <p class="comment-form-comment" style="margin-right:20%;">
