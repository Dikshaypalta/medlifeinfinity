<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageDoctor.master" AutoEventWireup="true" CodeFile="DoctorFeedback.aspx.cs" Inherits="_Default" %>
      ...
      <div class="container" style="margin-left:10%;">
        <div class="row">
                ...
                <div class="bhoechie-tab-content active">
                    <div class="row">
                        <div class="col-lg-8 col-md-8  col-sm-12 col-xs-12">
                            <h2 class="text-danger">Doctor To Doctor FeedBack</h2>
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div class="col-lg-11 col-md-11 col-sm-10 col-xs-10 bhoechie-tab">
                ...
                <asp:RequiredFieldValidator ID="rfvDName" runat="server" Display="Dynamic" ControlToValidate="txtDoctorName" ErrorMessage="Please Enter The Doctor Name" ForeColor="#009900"></asp:RequiredFieldValidator>
                                </label>
                                 </div>
                        </div>
